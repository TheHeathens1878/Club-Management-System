...
insert into public.waiting_list_entries (id, player_name, dob, age_group, parent_name, parent_email, parent_phone, status) values
  ('ac1dac1d-9999-4111-8111-000000000013', 'Kid Thirteen', '2041-09-01', 'U13', 'Pat Parent', 'cr13@test.invalid', '07700 900001', 'pending'),
  ('ac1dac1d-9999-4111-8111-000000000012', 'Kid Twelve',   '2042-09-01', 'U12', 'Pat Parent', 'cr12@test.invalid', '07700 900002', 'pending'),
  ('ac1dac1d-9999-4111-8111-000000000011', 'Kid Eleven',   '2043-09-01', 'U11', 'Pat Parent', 'cr11@test.invalid', '07700 900003', 'pending'),
  ('ac1dac1d-9999-4111-8111-000000000010', 'Kid Ten',      '2044-09-01', 'U10', 'Pat Parent', 'cr10@test.invalid', '07700 900004', 'pending'),
  ('ac1dac1d-9999-4111-8111-000000000099', 'Kid Done',     '2042-03-01', 'U12', 'Pat Parent', 'cr99@test.invalid', '07700 900005', 'accepted');
