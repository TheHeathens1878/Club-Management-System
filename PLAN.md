...
| P0.5 | Create `DECISIONS.md`, `SAFEGUARDING.md` (invariants from §2.4 expanded), and Linear project structure per phase | Docs exist; Linear issues created for Phase 1 | ☐ |
